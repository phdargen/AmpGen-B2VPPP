...
namespace AmpGen
{
  ...
  public:
    ...
    void writeToRootFile( TFile * output,  unsigned seed = 0, int verbose = 0, double nll = 0, unsigned numAmps = 0, double Ns = 0, std::vector<double> thresholds = {}, std::vector<double> numFracAboveThresholds = {}, double lambda = 0 );
