...
./LineshapePlotter.exe argand_v2/model_baselineModel_v2_fixed.txt argand_v2/all/Z2_spline.txt --plotSpline=2 --outDir=argand_v2/all/Z2 --Spline::NormBinBW=3 --ArgandMinX=-2. --ArgandMaxX=1.5 --ArgandLine=L --AmpMax=2 --ArgandMinY=-2 --ArgandMaxY=1.5 --fig_name="Fig19"
