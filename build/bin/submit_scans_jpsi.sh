...
#condor_submit i=scans_v2 o=scan_psiK_P.txt d=scan_psiK_P n=90 submitScan.sub
#condor_submit i=scans_v2 o=scan_psiK_V.txt d=scan_psiK_V n=90 submitScan.sub
#condor_submit i=scans_v2 o=scan_psiK_A.txt d=scan_psiK_A n=90 submitScan.sub
#condor_submit i=scans_v2 o=scan_psiK_T.txt d=scan_psiK_T n=90 submitScan.sub
#condor_submit i=scans_v2 o=scan_psiK_PT.txt d=scan_psiK_PT n=90 submitScan.sub
